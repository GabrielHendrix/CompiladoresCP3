...
gcc: scanner.c parser.c src/tables.c src/types.c src/ast.c src/code.c
	gcc -Wall -Wconversion -o trabalho scanner.c parser.c src/tables.c src/types.c src/ast.c src/code.c

tm: src/tm.c src/tables.c src/types.c
	gcc -Wall -Wconversion -o tmsim src/tm.c src/tables.c src/types.c
